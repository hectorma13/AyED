...
int main()
{
  ...
  // MODIFICACIÓN
  cout << "Suma de los grados de sp1: " << sp1.SumOfDegrees() << endl;
  cout << "Suma de los grados de sp2: " << sp2.SumOfDegrees() << endl;
  cout << "Suma de los grados de sp3: " << sp3.SumOfDegrees() << endl;
  return 0;
}
